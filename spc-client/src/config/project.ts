...
export const TECHNOLOGY_STACKS: StackConfig[] = [
  ...
  },
  {
    ...
    defaultFiles: ['package.json', 'src/App.tsx', 'public/index.html'],
  },
  {
    id: 'spring',
    label: 'Spring',
  ...
  },
  {
    ...
    defaultFiles: ['package.json', 'tsconfig.json', 'src/index.ts'],
  },
  {
    id: 'javascript',
    label: 'JavaScript',
  ...
  },
  {
    ...
    defaultFiles: ['package.json', 'src/App.vue', 'src/main.js'],
  },
  {
    id: 'python',
    label: 'Python',
